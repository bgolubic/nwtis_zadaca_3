...
<head>
<meta charset="UTF-8">
<title>Odabir adrese za meteo podatke</title>
</head>
<body>
	<%
	...
	<br />
	<form method="get"
		action="${pageContext.servletContext.contextPath}/mvc/meteo/adresa">
		<label for="adresa">Adresa:</label> <input name="adresa" type="text" /><br>
		<br> <input type="submit" value="Prikaži vrijeme za adresu" /><br>
	</form>
</body>
</html>