...
<head>
<meta charset="UTF-8">
<title>Odabir aerodroma za meteo podatke</title>
</head>
<body>
	<%
	...
	<br />
	<form method="get"
		action="${pageContext.servletContext.contextPath}/mvc/meteo/aerodrom">
		<label for="icao">ICAO:</label> <input name="icao" type="text" /><br>
		<br> <input type="submit" value="Prikaži vrijeme za aerodrom" /><br>
	</form>
</body>
</html>