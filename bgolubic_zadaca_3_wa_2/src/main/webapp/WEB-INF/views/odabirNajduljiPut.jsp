...
<head>
<meta charset="UTF-8">
<title>Odabir najdulji put</title>
</head>
<body>
<% ServletContext sc = request.getServletContext();
	...
	<form method="get" action="${pageContext.servletContext.contextPath}/mvc/aerodromi/najduljiPut">
		<label for="icao">ICAO:</label>
		<input name="icao" type="text" /><br><br>
		<input type="submit" value="Prikaži najdulji put države" /><br>
		</form>
</body>
</html>